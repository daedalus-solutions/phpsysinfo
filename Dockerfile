...
RUN cat /var/www/html/phpsysinfo/phpsysinfo.ini | sed 's/^PLUGINS=false/PLUGINS="PS,PSStatus"/' > /var/www/html/phpsysinfo/phpsysinfo.ini
RUN cat /var/www/html/phpsysinfo/phpsysinfo.ini | sed 's/^DEFAULT_DISPLAY_MODE="auto"/DEFAULT_DISPLAY_MODE="bootstrap"/' > /var/www/html/phpsysinfo/phpsysinfo.ini
